  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          ...
          <nav class="nav nav-masthead justify-content-center">
            ...
            <a class="nav-link" href="views/dataLatih/index.php">Data Latih</a>
            <a class="nav-link" href="views/dataUji/index.php">Data Uji</a>
      ...
      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p>&copy; 2019 <a href="http://si.fst.unair.ac.id">S1 Sistem Informasi Universitas Airlangga</a> </p>
        </div>
      </footer>
    </div>
